...
class JdbcCrudExtendedCompositeTests implements KoraAppTestConfigModifier {

    @ConnectionPostgreSQL
    private JdbcConnection connection;

    @TestComponent
    private JdbcCrudExtendedCompositeRepository repository;
    ...
    void syncSingle() {
        // given
        var id = new JdbcCrudExtendedCompositeRepository.Entity.EntityId();
        var entityCreate = new JdbcCrudExtendedCompositeRepository.Entity(
                id, "2");
        ...
        // when
        var entityUpdate = new JdbcCrudExtendedCompositeRepository.Entity(
                id, "6");
    ...
    void syncBatch() {
        // given
        var id1 = new JdbcCrudExtendedCompositeRepository.Entity.EntityId();
        var id2 = new JdbcCrudExtendedCompositeRepository.Entity.EntityId();
        var entityCreate1 = new JdbcCrudExtendedCompositeRepository.Entity(id1, "2");
        var entityCreate2 = new JdbcCrudExtendedCompositeRepository.Entity(id2, "4");
        ...
        // when
        var entityUpdate1 = new JdbcCrudExtendedCompositeRepository.Entity(id1, "6");
        var entityUpdate2 = new JdbcCrudExtendedCompositeRepository.Entity(id2, "8");
        ...
        var entityUpsert1 = new JdbcCrudExtendedCompositeRepository.Entity(id1, "8");
        var entityUpsert2 = new JdbcCrudExtendedCompositeRepository.Entity(id2, "10");

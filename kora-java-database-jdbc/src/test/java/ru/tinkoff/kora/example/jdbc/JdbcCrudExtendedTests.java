...
class JdbcCrudExtendedTests implements KoraAppTestConfigModifier {

    @ConnectionPostgreSQL
    private JdbcConnection connection;

    @TestComponent
    private JdbcCrudExtendedRepository repository;
    ...
    void syncSingle() {
        // given
        var entityCreate = new JdbcCrudExtendedRepository.Entity("1", 1, "2", null);
        ...
        // when
        var entityUpdate = new JdbcCrudExtendedRepository.Entity("1", 5, "6", null);
    ...
    void syncBatch() {
        // given
        var entityCreate1 = new JdbcCrudExtendedRepository.Entity("1", 1, "2", null);
        var entityCreate2 = new JdbcCrudExtendedRepository.Entity("2", 3, "4", null);
        ...
        // when
        var entityUpdate1 = new JdbcCrudExtendedRepository.Entity("1", 5, "6", null);
        var entityUpdate2 = new JdbcCrudExtendedRepository.Entity("2", 7, "8", null);
        ...
        var entityUpsert1 = new JdbcCrudExtendedRepository.Entity("1", 7, "8", null);
        var entityUpsert2 = new JdbcCrudExtendedRepository.Entity("2", 9, "10", null);

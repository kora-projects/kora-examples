...
class R2dbcCrudSyncTests implements KoraAppTestConfigModifier {
    ...
    @TestComponent
    private R2dbcCrudSyncRepository repository;
    ...
    void monoSingleSuccess() {
        // given
        var entityCreate = new R2dbcCrudSyncRepository.Entity("1", 1, "2", null);
        ...
        // when
        var entityUpdate = new R2dbcCrudSyncRepository.Entity("1", 5, "6", null);
    ...
    void monoBatchSuccess() {
        // given
        var entityCreate1 = new R2dbcCrudSyncRepository.Entity("1", 1, "2", null);
        var entityCreate2 = new R2dbcCrudSyncRepository.Entity("2", 3, "4", null);
        assertEquals(2L, repository.insertBatch(List.of(entityCreate1, entityCreate2)).value());
        ...
        // when
        var entityUpdate1 = new R2dbcCrudSyncRepository.Entity("1", 5, "6", null);
        var entityUpdate2 = new R2dbcCrudSyncRepository.Entity("2", 7, "8", null);

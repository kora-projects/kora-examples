...
class CassandraCrudSyncTests implements KoraAppTestConfigModifier {
    ...
    @TestComponent
    private CassandraCrudSyncRepository repository;
    ...
    void syncSingleSuccess() {
        // given
        var entityCreate = new CassandraCrudSyncRepository.Entity("1", 1, "2", null);
        ...
        // when
        var entityUpdate = new CassandraCrudSyncRepository.Entity("1", 5, "6", null);
    ...
    void syncBatchSuccess() {
        // given
        var entityCreate1 = new CassandraCrudSyncRepository.Entity("1", 1, "2", null);
        var entityCreate2 = new CassandraCrudSyncRepository.Entity("2", 3, "4", null);
        repository.insertBatch(List.of(entityCreate1, entityCreate2));
        ...
        // when
        var entityUpdate1 = new CassandraCrudSyncRepository.Entity("1", 5, "6", null);
        var entityUpdate2 = new CassandraCrudSyncRepository.Entity("2", 7, "8", null);
        repository.updateBatch(List.of(entityUpdate1, entityUpdate2));

package io.koraframework.example.crud.controller;

import io.koraframework.common.annotation.Component;
import io.koraframework.example.crud.service.PetService;
import io.koraframework.example.crud.model.mapper.PetMapper;
import io.koraframework.example.crud.openapi.http.server.api.PetApiDelegate;
import io.koraframework.example.crud.openapi.http.server.api.PetApiResponses.AddPetApiResponse;
import io.koraframework.example.crud.openapi.http.server.api.PetApiResponses.DeletePetApiResponse;
import io.koraframework.example.crud.openapi.http.server.api.PetApiResponses.GetPetByIdApiResponse;
import io.koraframework.example.crud.openapi.http.server.api.PetApiResponses.UpdatePetApiResponse;

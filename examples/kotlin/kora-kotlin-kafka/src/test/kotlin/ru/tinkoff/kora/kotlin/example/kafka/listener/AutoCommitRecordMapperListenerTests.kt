...
class AutoCommitRecordMapperListenerTests : KoraAppTestConfigModifier {
    @ConnectionKafka
    ...
    @TestComponent
    lateinit var consumer: AutoCommitRecordMapperListener
    ...
    fun processed() {
        ...
        assertEquals(1, consumer.received()[0].code)
    }
}

# Kora Guide Kotlin HTTP Client App

This module is the runnable Kotlin/Gradle companion application for
the [HTTP Client guide](../../../agents-md/kora-docs/mkdocs/docs/en/guides/http-client.md). It demonstrates declarative
Kora HTTP clients, typed request/response models, client configuration, and local integration testing.
...
```bash
./gradlew :guides:kotlin:kora-kotlin-guide-http-client-app:classes
./gradlew :guides:kotlin:kora-kotlin-guide-http-client-app:test
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-http-client-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:kotlin:kora-kotlin-guide-http-client-app:distTar
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-http-client-app:run
```

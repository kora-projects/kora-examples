...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-dependency-injection:kora-kotlin-guide-dependency-injection-lib:classes
```

Compile test classes without running tests:

```shell
./gradlew :guides:kotlin:kora-kotlin-guide-dependency-injection:kora-kotlin-guide-dependency-injection-lib:testClasses
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-dependency-injection:kora-kotlin-guide-dependency-injection-lib:test
```

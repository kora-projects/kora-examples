# Kora Guide Kotlin HTTP Client Advanced App

This module is the runnable Kotlin/Gradle companion application for
the [HTTP Client Advanced guide](../../../agents-md/kora-docs/mkdocs/docs/en/guides/http-client-advanced.md). It
demonstrates advanced HTTP client usage, including interceptors, manual calls through Kora HttpClient, and explicit
request composition.
...
```bash
./gradlew :guides:kotlin:kora-kotlin-guide-http-client-advanced-app:classes
./gradlew :guides:kotlin:kora-kotlin-guide-http-client-advanced-app:test
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-http-client-advanced-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:kotlin:kora-kotlin-guide-http-client-advanced-app:distTar
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-http-client-advanced-app:run
```

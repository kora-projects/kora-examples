...
tasks.test {
    dependsOn(":guides:kotlin:kora-kotlin-guide-http-server-advanced-app:distTar")
    inputs.file("../kora-kotlin-guide-http-server-advanced-app/Dockerfile")
    inputs.file("../kora-kotlin-guide-http-server-advanced-app/build/distributions/application.tar")

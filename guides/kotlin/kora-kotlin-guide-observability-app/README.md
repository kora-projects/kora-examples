# Kora Guide Kotlin Observability App

This module is the runnable Kotlin/Gradle companion application for
the [Observability guide](../../../agents-md/kora-docs/mkdocs/docs/en/guides/observability.md). It demonstrates logs,
metrics, tracing, probes, and the Kora telemetry modules used to observe an application from the first run.
...
- Logging
  SLF4J: [EN](https://kora-projects.github.io/kora-docs/en/documentation/logging-slf4j/) / [RU](https://kora-projects.github.io/kora-docs/ru/documentation/logging-slf4j/).
-
...
```bash
./gradlew :guides:kotlin:kora-kotlin-guide-observability-app:classes
./gradlew :guides:kotlin:kora-kotlin-guide-observability-app:test
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-observability-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:kotlin:kora-kotlin-guide-observability-app:distTar
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-observability-app:run
```
...
```shell
docker compose -f guides/kotlin/kora-kotlin-guide-observability-app/docker-compose.yml up -d
```

Stop it when finished:

```shell
docker compose -f guides/kotlin/kora-kotlin-guide-observability-app/docker-compose.yml down
```

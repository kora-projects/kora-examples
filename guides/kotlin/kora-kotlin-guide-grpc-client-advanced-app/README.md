# Kora Guide Kotlin gRPC Client Advanced App

This module is the runnable Kotlin/Gradle companion application for
the [gRPC Client Advanced guide](../../../agents-md/kora-docs/mkdocs/docs/en/guides/grpc-client-advanced.md). It extends
gRPC client usage with more explicit generated client behavior, error handling, and advanced request patterns.
...
```bash
./gradlew :guides:kotlin:kora-kotlin-guide-grpc-client-advanced-app:classes
./gradlew :guides:kotlin:kora-kotlin-guide-grpc-client-advanced-app:test
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-grpc-client-advanced-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:kotlin:kora-kotlin-guide-grpc-client-advanced-app:distTar
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-grpc-client-advanced-app:run
```

# Kora Guide Kotlin Testing JUnit App

This module is the runnable Kotlin/Gradle companion application for
the [Testing JUnit guide](../../../agents-md/kora-docs/mkdocs/docs/en/guides/testing-junit.md). It demonstrates Kora
JUnit 5 component tests, graph customization, component injection into tests, and controlled test-time dependencies.
...
```bash
./gradlew :guides:kotlin:kora-kotlin-guide-testing-junit-app:classes
./gradlew :guides:kotlin:kora-kotlin-guide-testing-junit-app:test
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-testing-junit-app:testClasses
```

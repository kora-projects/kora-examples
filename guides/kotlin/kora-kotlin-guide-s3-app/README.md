...
- S3
  Client: [EN](https://kora-projects.github.io/kora-docs/en/documentation/s3-client/) / [RU](https://kora-projects.github.io/kora-docs/ru/documentation/s3-client/).

## Run Checks

```bash
./gradlew :guides:kotlin:kora-kotlin-guide-s3-app:classes
./gradlew :guides:kotlin:kora-kotlin-guide-s3-app:test
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-s3-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:kotlin:kora-kotlin-guide-s3-app:distTar
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-s3-app:run
```
...
```shell
docker compose -f guides/kotlin/kora-kotlin-guide-s3-app/docker-compose.yml up -d
```

Stop it when finished:

```shell
docker compose -f guides/kotlin/kora-kotlin-guide-s3-app/docker-compose.yml down
```

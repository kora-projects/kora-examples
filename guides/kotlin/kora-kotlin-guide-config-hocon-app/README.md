# Kora Guide Kotlin Config HOCON App

This module is the runnable Kotlin/Gradle companion application for
the [Config HOCON guide](../../../agents-md/kora-docs/mkdocs/docs/en/guides/config-hocon.md). It demonstrates typed
configuration binding with HOCON, environment overrides, nested configuration objects, and generated config extractors.
...
```bash
./gradlew :guides:kotlin:kora-kotlin-guide-config-hocon-app:classes
./gradlew :guides:kotlin:kora-kotlin-guide-config-hocon-app:test
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-config-hocon-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:kotlin:kora-kotlin-guide-config-hocon-app:distTar
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-config-hocon-app:run
```

# Kora Guide Kotlin Testing Black Box App

This module is the runnable Kotlin/Gradle companion application for
the [Testing Black Box guide](../../../agents-md/kora-docs/mkdocs/docs/en/guides/testing-black-box.md). It demonstrates
black-box testing through real application boundaries so HTTP behavior, configuration, and generated wiring are verified
together.
...
```bash
./gradlew :guides:kotlin:kora-kotlin-guide-testing-black-box-app:classes
./gradlew :guides:kotlin:kora-kotlin-guide-testing-black-box-app:test
```
...
```shell
./gradlew :guides:kotlin:kora-kotlin-guide-testing-black-box-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:kotlin:kora-kotlin-guide-testing-black-box-app:distTar
```

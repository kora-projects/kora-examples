# Kora Guide Getting Started App

This module is the runnable Java/Gradle companion application for the [Getting Started guide](../../agents-md/kora-docs/mkdocs/docs/en/guides/getting-started.md). It shows the smallest runnable Kora application: a compile-time DI graph, application entry point, configuration file, and generated graph classes that make the framework behavior visible.
...
## Run Checks
```bash
./gradlew :guides:java:kora-java-guide-getting-started-app:classes
./gradlew :guides:java:kora-java-guide-getting-started-app:test
```
...
```shell
./gradlew :guides:java:kora-java-guide-getting-started-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:java:kora-java-guide-getting-started-app:distTar
```
...
```shell
./gradlew :guides:java:kora-java-guide-getting-started-app:run
```

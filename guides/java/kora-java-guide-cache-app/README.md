# Kora Guide Cache App

This module is the runnable Java/Gradle companion application for the [Cache guide](../../agents-md/kora-docs/mkdocs/docs/en/guides/cache.md). It demonstrates declarative caching with generated aspects, cache annotations, key handling, and a service method that becomes cache-aware through Kora code generation.
...
```shell
./gradlew :guides:java:kora-java-guide-cache-app:distTar
```
...
```shell
./gradlew :guides:java:kora-java-guide-cache-app:run
```

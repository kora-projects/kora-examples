# Kora Guide gRPC Server App

This module is the runnable Java/Gradle companion application for the [gRPC Server guide](../../agents-md/kora-docs/mkdocs/docs/en/guides/grpc-server.md). It demonstrates protobuf-first service contracts, generated gRPC server bindings, and a Kora component implementation behind the service.
...
## Run Checks
```bash
./gradlew :guides:java:kora-java-guide-grpc-server-app:classes
./gradlew :guides:java:kora-java-guide-grpc-server-app:test
```
...
```shell
./gradlew :guides:java:kora-java-guide-grpc-server-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:java:kora-java-guide-grpc-server-app:distTar
```
...
```shell
./gradlew :guides:java:kora-java-guide-grpc-server-app:run
```

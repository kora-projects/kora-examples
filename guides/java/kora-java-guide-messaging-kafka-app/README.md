# Kora Guide Messaging Kafka App

This module is the runnable Java/Gradle companion application for the [Messaging Kafka guide](../../agents-md/kora-docs/mkdocs/docs/en/guides/messaging-kafka.md). It demonstrates Kafka producer and consumer components, record serialization, configuration, and local message-flow verification.
...
## Run Checks
```bash
./gradlew :guides:java:kora-java-guide-messaging-kafka-app:classes
./gradlew :guides:java:kora-java-guide-messaging-kafka-app:test
```
...
```shell
./gradlew :guides:java:kora-java-guide-messaging-kafka-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:java:kora-java-guide-messaging-kafka-app:distTar
```
...
```shell
./gradlew :guides:java:kora-java-guide-messaging-kafka-app:run
```
...
```shell
docker compose -f guides/java/kora-java-guide-messaging-kafka-app/docker-compose.yml up -d
```

Stop it when finished:

```shell
docker compose -f guides/java/kora-java-guide-messaging-kafka-app/docker-compose.yml down
```

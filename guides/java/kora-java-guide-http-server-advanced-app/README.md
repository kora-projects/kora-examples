# Kora Guide HTTP Server Advanced App

This module is the runnable Java/Gradle companion application for the [HTTP Server Advanced guide](../../agents-md/kora-docs/mkdocs/docs/en/guides/http-server-advanced.md). It expands manual HTTP server usage with request handlers, interceptors, custom exception handling, form processing, and lower-level HTTP server extension points.
...
## Run Checks
```bash
./gradlew :guides:java:kora-java-guide-http-server-advanced-app:classes
./gradlew :guides:java:kora-java-guide-http-server-advanced-app:test
```
...
```shell
./gradlew :guides:java:kora-java-guide-http-server-advanced-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:java:kora-java-guide-http-server-advanced-app:distTar
```
...
```shell
./gradlew :guides:java:kora-java-guide-http-server-advanced-app:run
```

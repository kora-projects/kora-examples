# Kora Guide OpenAPI HTTP Client App

This module is the runnable Java/Gradle companion application for the [OpenAPI HTTP Client guide](../../agents-md/kora-docs/mkdocs/docs/en/guides/openapi-http-client.md). It demonstrates OpenAPI-driven client generation and how generated clients are wired into Kora applications.
...
## Run Checks
```bash
./gradlew :guides:java:kora-java-guide-openapi-http-client-app:classes
./gradlew :guides:java:kora-java-guide-openapi-http-client-app:test
```
...
```shell
./gradlew :guides:java:kora-java-guide-openapi-http-client-app:testClasses
```

Build the runnable distribution archive:

```shell
./gradlew :guides:java:kora-java-guide-openapi-http-client-app:distTar
```
...
```shell
./gradlew :guides:java:kora-java-guide-openapi-http-client-app:run
```

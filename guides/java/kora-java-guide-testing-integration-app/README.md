# Kora Guide Testing Integration App

This module is the runnable Java/Gradle companion application for the [Testing Integration guide](../../agents-md/kora-docs/mkdocs/docs/en/guides/testing-integration.md). It demonstrates integration testing with a real Kora graph, external dependency configuration, and application-level verification.
...
## Run Checks
```bash
./gradlew :guides:java:kora-java-guide-testing-integration-app:classes
./gradlew :guides:java:kora-java-guide-testing-integration-app:test
```
...
```shell
./gradlew :guides:java:kora-java-guide-testing-integration-app:testClasses
```
